...
public class ModelManip {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ICI on fait jouer la transivité sur les sous-classes de concepts a partir d'une sous-proprieté");
	...
	// CrÃ©ation modÃ¨le implicite
        InfModel inf_m = ModelFactory.createRDFSModel(m);
	// Ajout de dÃ©clas par le raisonneur RDFS
        System.out.println("--------------------------------------------");
        System.out.println("Les livres traitant de " + database_concept.getLocalName());
        // la transivitÃ© ne s'applique pas skosBroader -> necessite le passage Ã  owl
	...
	// "database_concept" = concept sur lequel on veut interroger
        ...
        // ICI on fait jouer la transivitÃ© sur les sous-classes de concepts Ã  partir d'individus 
	// attaches a ces concepts
        System.out.println("--------------------------------------------");
        System.out.println("Une solution faisant jouer l'inférence sur les individus est aussi proposée :");
        System.out.println("");
        ...
        // Recherche des individus sur le concept parcouru, utilise l'infÃ©rence
