...
public class livresEtSkos {
	// Namespaces
	public static final String fileCS = "seb/computerscience.rdf";
	public static final String fileBooks = "seb/livres.rdf";
    ...
    public static void main( String[] args ) {
    	...
    	try {
			FileOutputStream ost = new FileOutputStream("seb/livres_et_computerscience.rdf");
