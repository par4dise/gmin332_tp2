...
public class Q2 {
	...
	public static void main( String[] args ) {
    	...
    	// predicats qui vont pointer sur des litteraux types, pas d'équivalent dc.xxx
    	//Property DC.date = m.createProperty(ns+"DC.date");
    	...
    	//Resource Author = m.createResource(ns2+"Author");
    	
    	// Remplacement par DC.creator, ...
    	//Property PublicationAuthor = m.createProperty(ns+"PublicationAuthor");
    	//Property DC.title = m.createProperty(ns+"DC.title");
    	...
    	b1.addLiteral(DC.date, l_year1);
    	b1.addLiteral(PublicationPrice, l_price1);
    	m.add(b1, DC.title, l_title1);
